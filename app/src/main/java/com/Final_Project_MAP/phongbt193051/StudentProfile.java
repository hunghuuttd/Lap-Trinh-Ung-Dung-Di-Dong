...
import com.Final_Project_MAP.phongbt193051.Adapter.SpecificAttendanceAdapter;
        ...
        if(intent != null){
            ...
            delete_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    builder.setMessage("Confirmation of deletion")
                            .setCancelable(true)
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    FirebaseDatabase.getInstance().getReference("Classes").child(Common.currentClassName)
                                        ...
                                        public void onSuccess(Void unused) {
                                            Toast.makeText(StudentProfile.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                                            finish();
                                        }
                                    });
                                }
